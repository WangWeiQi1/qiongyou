    ...
    <div>
        ...
        <div class="layout">
            <Sider :style="{position: 'fixed', height: '100vh', left: 0, overflow: 'auto'}">
                <Menu active-name="1-1" theme="dark" width="auto" :open-names="['1']"  @on-select='selectMethod'>
                    <Submenu name="1">
                        <template slot="title">
                            <Icon type="ios-navigate"></Icon>
                            Item 1
                        </template>
                        <MenuItem name="1-1">发布区域</MenuItem>
                        <MenuItem name="1-2">管理区域</MenuItem>
                    ...
                    <Card>
                        <div style="height: 600px">
                            ...
                            <div class='upload-main'>
                                ...
                                上传多张相关图片
                                <Modal title="View Image" v-model="visible">
                                    <img :src="`${domain}/assets/uploads/${imgName_more}`" v-if="visible" style="width: 100%">
